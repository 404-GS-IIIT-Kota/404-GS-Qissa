        ...
        <div className="w-4/5 h-full py-5">
          <div className="flex justify-between items-center  mb-5 flex-wrap md:flex-nowrap">
            ...
            <select
              id="blogtype"
              name="blogtype"
              className="w-full md:w-2/5 px-4  py-2 mt-4 md:mt-0 border rounded-md focus:outline-none focus:border-slate-500 border-gray-300 transition-all duration-500 ease-in-out" // Added transition here
            >
